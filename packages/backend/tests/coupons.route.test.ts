      ...
      const mockCoupons = [
        {
          ...
          total_redemptions: 5,
          remaining_uses: 95,
          starts_at_taipei: '2026-01-01T08:00:00.000Z',
          ends_at_taipei: '2027-01-01T07:59:59.000Z',
          created_at_taipei: '2026-01-01T08:00:00.000Z',
          updated_at_taipei: '2026-01-01T08:00:00.000Z',
          is_valid: true,
          is_expired: false,
  ...
  describe('POST /api/coupons', () => {
    it('應該成功建立新優惠券（百分比折扣）', async () => {
      ...
      const createdCoupon = {
        ...
        remaining_uses: 50,
        starts_at_taipei: '2026-01-01T08:00:00.000Z',
        ends_at_taipei: '2026-12-31T23:59:59.000Z',
        created_at_taipei: '2026-01-01T08:00:00.000Z',
        updated_at_taipei: '2026-01-01T08:00:00.000Z',
        is_valid: true,
        is_expired: false,
  ...
  describe('PUT /api/coupons/:id', () => {
    it('應該成功更新優惠券', async () => {
      ...
      const updatedCoupon = {
        ...
        updated_at_taipei: '2026-01-02T08:00:00.000Z',
        remaining_uses: 195,
      };
